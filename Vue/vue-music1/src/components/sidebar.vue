<template>
  <div class="sidebar" :class="{showSidebar: showSidebar}">
    <div class="sidebar-con" :class="{showbar: showSidebar}">
      <div class="head">
        <div class="avatar">
          <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1561045754093&di=c718dd339c66568ca4fcb5b8fee7aa84&imgtype=0&src=http%3A%2F%2Fimg.alicdn.com%2Fimgextra%2Fi4%2F756111608%2FTB2k_OseQ5M.eBjSZFrXXXPgVXa_%2521%2521756111608-null-weitao.jpeg" alt="">
        </div>
